...
using LoginScreen.BusinessLayer;
...
namespace LoginScreen
{
    public partial class frmLogin : Form
    {
        ...
        {
           bd =new BLLUser(string.Format("{0}/User.txt",Application.StartupPath));
        }
        ...
        private bool KiemTraDangNhap(string txtUserName, string txtpassword)
        {
            return bd.KiemTraTaiKhoan(txtUserName, txtpassword);
        }
